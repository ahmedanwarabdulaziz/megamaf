-- 0046_fix_claim_totals_again.sql
...
-- Recreate v_claim_totals using the ORIGINAL phase 5 logic for prior claims
...
-- Restore v_project_financial_position EXACTLY as it was
...
WITH vendor_docs AS (
    ...
    -- Vendor Prior Claims (Opening balances)
    SELECT
