...
import { addBankAccount } from "@/app/(app)/accounts/actions"
...
function SubmitButton() {
  ...
  return (
    <Button type="submit" disabled={pending}>
      {pending ? "جاري الحفظ..." : "إضافة حساب"}
    </Button>
  )
}

export function AddBankAccountModal({ banks }: { banks: any[] }) {
  const [state, formAction] = useActionState(addBankAccount as any, { error: "", success: false })
  ...
  return (
    <Modal name="add-bank-account" title="إضافة حساب بنكي" description="أدخل تفاصيل الحساب البنكي الجديد.">
